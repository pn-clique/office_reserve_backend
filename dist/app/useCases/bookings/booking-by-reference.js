...
exports.BookingByReferenceUseCase = void 0;
const contracts_1 = require("../../../@shareds/contracts");
const prisma_db_1 = __importDefault(require("../../../infra/database/prisma-db"));
class BookingByReferenceUseCase {
    async execute(request) {
        try {
            const booking = await prisma_db_1.default.booking.findUnique({ where: { reference: request }, include: { user: true, place: true, modality: true, } });
            if (!booking) {
...
exports.BookingByReferenceUseCase = BookingByReferenceUseCase;
